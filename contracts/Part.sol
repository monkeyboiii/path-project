...
contract Part is IERC721 {
    ...
    mapping(uint => uint[]) public _dependency;
    ...
    function collectionOf(address owner) public view virtual returns (uint256[]) {
        require(
            owner != address(0),
            "ERC721: collection query for the zero address"
        );
